...
# ROBUST HARD-CODED FRINGE DETECTION
#
# DUNKEL  <= 400
# HELL    >= 800
#
# Fringe wird NUR gezählt wenn:
# 1. mehrere dunkle Frames erkannt wurden
# 2. danach lange genug helle Frames erkannt wurden
# 3. cooldown vorbei ist
#
# Kleine Peaks / Ausreißer werden ignoriert
# =========================================================
...
# Intensitätsschwellwerte

DARK_LIMIT = 100

BRIGHT_LIMIT = 400

# Wie viele stabile Frames nötig sind

REQUIRED_DARK_FRAMES = 3

REQUIRED_BRIGHT_FRAMES = 3

# Sperrzeit gegen Mehrfachzählung
...
class InterferometerApp(ctk.CTk):
    ...
    def update_accumulated_fringes(self, intensity):
        ...
        if len(self.intensity_history) > 8:
            self.intensity_history.pop(0)

        # -------------------------------------------------
        # Glättung gegen Ausreißer
        # -------------------------------------------------
        ...
        if smooth_intensity <= DARK_LIMIT:
        ...
        if smooth_intensity >= BRIGHT_LIMIT:
